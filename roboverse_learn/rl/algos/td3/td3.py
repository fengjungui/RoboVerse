...
from .utils import AverageScalarMeter, RunningMeanStd, AdaptiveScheduler, LinearScheduler
...
class TD3(object):
    ...
    def write_stats(self, actor_losses, critic_losses):
        log_dict = {
            ...
            "info/replay_buffer_size": self.replay_buffer.idx if not self.replay_buffer.full else self.replay_buffer.capacity,
    ...
    def update_networks(self):
        ...
        with torch.no_grad():
            next_actions = self.actor_target.act(
                next_obs_dict, 
                target_noise=self.policy_noise,
    ...
    def play_steps(self):
        ...
        self.replay_buffer.add(
            obs_tensor,
            actions,
            rewards.view(self.num_actors, 1),
            next_obs_tensor,
            dones.view(self.num_actors, 1)
        )
