...
class AnymalCfg(BaseTaskCfg):
    ...
    def get_observation(self, states):
        ...
        for i, env_state in enumerate(states):
            ...
            base_quat = torch.tensor(robot_state.get("rot", [1., 0., 0., 0.]), dtype=torch.float32)
            ...
            commands_scaled = commands * torch.tensor([self.lin_vel_scale, self.lin_vel_scale, self.ang_vel_scale], dtype=torch.float32, device=base_quat.device)
